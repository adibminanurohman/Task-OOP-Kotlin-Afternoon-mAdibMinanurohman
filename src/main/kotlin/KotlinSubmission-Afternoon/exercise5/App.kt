...
fun main() {
     ...
     *
     */
    setProfile(hero, "Muhamad Adib Minanurohman", 21, 170)
    ...
    **/
     ...
     *
     */
    println("\nData Profile Setelah Aktivitas:")
    printProfile(hero)
...
fun challengeActivity(hero: Hero) {
    // Class B Afternoon
    hero.jalan()
    hero.jalan()
    hero.jalan()
...
fun setProfile(hero: Hero, name: String, age: Int, height: Int) {
